...
namespace Autofac.Extensions.DependencyInjection
{
    ...
    public class AutofacSiblingServiceProviderFactory : IServiceProviderFactory<ContainerBuilder>
    {
        ...
        /// </summary>
        /// <param name="configurationAction">Action on a <see cref="ContainerBuilder"/> that adds component registrations to the container..</param>
        public AutofacSiblingServiceProviderFactory(Action<ContainerBuilder> configurationAction = null) =>
